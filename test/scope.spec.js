...
describe('Scope', function(){
  describe('digest', function(){
    ...
    it('has a $$phase field whose vlaue is the curent digest phase', function(){
      scope.aValue = [1,2,3];
    ...
    it('coalesces many calls ti $applyAsync', function(done){
      scope.counter = 0;
  ...
  describe('inheritance', function(){
    ...
    it('does not shadow members of parent scopes attributes', function(){
      ...
      expect(parent.user.name).toBe('Joe');
      expect(child.user.name).toBe('Joe');
    });
    ...
    it('executes $$postDigest functiona on isolated scopes', function(){
  ...
  describe('Events', function(){
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('passes an event object within a name to listeners on ' + method, function(){
      ...
      it('does not stop on exceptions on ' + method, function(){
        var listener1 = function(event){
          throw 'listener1 throws exception';
        };
        var listener2 = jasmine.createSpy();
        scope.$on('someEvent', listener1);
        scope.$on('someEvent', listener2);
