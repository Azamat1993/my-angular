...
describe('hash', function(){
  ...
  describe('hashKey', function(){
    ...
    it('is not the same for different objects when the same value', function(){
      var obj1 = {a:42};
      var obj2 = {a:42};
    ...
    it('is not the same for different identical functions', function(){
      ...
      expect(hashKey(fn1)).not.toEqual(fn2);
    });
  ...
  describe('HashMap', function(){
    it('supports put and get primitives', function(){
      var map = new HashMap();
      map.put(42, 'fourty four');
      expect(map.get(42)).toEqual('fourty four');
    });
    ...
    it('returns value from remove', function(){
      ...
      expect(value).toEqual('fourty four');
    });
  });
});
